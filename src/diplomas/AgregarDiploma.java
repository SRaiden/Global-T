...
public class AgregarDiploma extends JPanel {
	...
	public AgregarDiploma() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Agregar Diploma", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 0, 0)));
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					CursosVO cur = CursosDAO.BuscarUnCurso(codleg);
					
					txtModulo1.setText(cur.getModulo_uno() + "");
					txtModulo2.setText(cur.getModulo_dos() + "");
					txtModulo3.setText(cur.getModulo_tres() + "");
					txtModulo4.setText(cur.getModulo_cuatro() + "");
					txtModulo5.setText(cur.getModulo_cinco() + "");
					txtModulo6.setText(cur.getModulo_seis() + "");
					txtModulo7.setText(cur.getModulo_siete() + "");
					txtModulo8.setText(cur.getModulo_ocho() + "");
					txtModulo9.setText(cur.getModulo_nueve() + "");
					txtModulo10.setText(cur.getModulo_diez() + "");
					
					if(cur.getModulo_uno().isEmpty()){
					...
					}else if(cur.getModulo_dos().isEmpty()){
						txtNota2.setEditable(false);
						txtNota3.setEditable(false);
						txtNota4.setEditable(false);
						txtNota5.setEditable(false);
						...
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_tres().isEmpty()){
						txtNota3.setEditable(false);
						txtNota4.setEditable(false);
						txtNota5.setEditable(false);
						txtNota6.setEditable(false);
						...
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_cuatro().isEmpty()){
						txtNota4.setEditable(false);
						txtNota5.setEditable(false);
						txtNota6.setEditable(false);
						txtNota7.setEditable(false);
						...
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_cinco().isEmpty()){
						txtNota5.setEditable(false);
						txtNota6.setEditable(false);
						txtNota7.setEditable(false);
						txtNota8.setEditable(false);
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_seis().isEmpty()){
						txtNota6.setEditable(false);
						txtNota7.setEditable(false);
						txtNota8.setEditable(false);
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_siete().isEmpty()){
						txtNota7.setEditable(false);
						txtNota8.setEditable(false);
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_ocho().isEmpty()){
						txtNota8.setEditable(false);
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_nueve().isEmpty()){
						txtNota9.setEditable(false);
						txtNota10.setEditable(false);
					}else if(cur.getModulo_diez().isEmpty()){
						txtNota10.setEditable(false);
					}else{
		...
		btnAgregar.setBounds(963, 296, 107, 35);
