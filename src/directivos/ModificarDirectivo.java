...
public class ModificarDirectivo extends JPanel {
	...
	public ModificarDirectivo() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Modificar Directivo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 0, 0)));
		...
		txtEstado.setBounds(547, 307, 159, 23);
		panel_1.add(txtEstado);
		
		JComboBox cmbTipoDNI = new JComboBox();
		
		cmbTipoDNI.setBounds(508, 156, 200, 20);
		...
		btnBuscarXCodigo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					cmbTipoDNI.setSelectedItem(tipodni);
					...
					txtEstado.setText(dir.getTipo_Estado());
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String das = (String) txtCodigo.getText();
				int coddir = Integer.parseInt(das);;
				
				dir.setCod_Directivo(coddir);
				...
				dir.setTipo_Estado(txtEstado.getText());
				try {
					String resp = DirectivosDAO.ActualizarDirectivo(dir, coddir);
		...
		btnModificar.setBounds(725, 302, 129, 35);
