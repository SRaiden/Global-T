...
public class VerDirectivo extends JPanel {
	...
	public VerDirectivo() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Ver Directivo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 0, 0)));
		...
		txtTipoDocumento.setBounds(508, 156, 200, 23);
