...
public class ModificarHorario extends JPanel {
	...
	public ModificarHorario() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Modificar Horario", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 0, 0)));
		...
		btnModificar.setBounds(1039, 296, 107, 35);
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					cmbSemana1.setSelectedItem(hor.getDia_uno());
					cmbSemana2.setSelectedItem(hor.getDia_dos());
					cmbSemana3.setSelectedItem(hor.getDia_tres());
					cmbSemana4.setSelectedItem(hor.getDia_cuatro());
					cmbSemana5.setSelectedItem(hor.getDia_cinco());
					cmbSemana6.setSelectedItem(hor.getDia_seis());
					cmbSemana7.setSelectedItem(hor.getDia_siete());
					cmbSemana8.setSelectedItem(hor.getDia_ocho());
					cmbSemana9.setSelectedItem(hor.getDia_nueve());
					cmbSemana10.setSelectedItem(hor.getDia_diez());
